...
funct5 = gcurve(title = 'Time vs Spring Oscillations', xtitle = 'Time (s)', ytitle = 'Distance from ceiling')
...
#Simulate the conditions for the spring-mass system being submersed in crude mexican oil with a density of 973 kg/m^3
Volume_sphere = (4/3)*pi*(pow(ball.radius,3))
Density_oil = 20
Buoyant_force = Volume_sphere * Density_oil * g * vector(0,1,0)
Fnet = Fgrav+Fspring+Buoyant_force
...
while t<10:
       ...
       #Create line to account for elastic energy (spring)
        ...
        #print(elastic_kinetic_energy)
        #Create line to account gravitational potential energy
        gravitational_potential_energy = abs(mball * g * s)
        # Create line to account for kinetic energy (spring)
...
# Graph of ball's motion
        ...
        f5 = funct4.plot(pos = (t,gravitational_potential_energy), title = 'Spring Oscillation Behavior', xtitle = 'Time (seconds)',  color = color.magenta)
